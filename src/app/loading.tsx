  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <div className="mt-8">
          <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-purple-600">
            <span className="text-xl font-bold text-white">A</span>
          </div>
          <p className="text-sm font-medium text-gray-400">AMAN Store</p>
        </div>
      </div>
    </div>
  );
